        ...
        <div className=' h-fit min-h-screen w-fit border-2 border-gray-950'>
            ...
            <div className=' w-full h-fit p-4 pt-10'>
                ...
                <div className=' w-full pt-12 flex lg:flex-row flex-col-reverse lg:pl-28 gap-12'>
                    <p className=' w-full text-2xl lg:w-3/6'>Our mission at Evaluxe Pharmaceuticals is clear:
            ...
            <div className=' pt-10 w-full h-fit'>
                <h2 className=' text-4xl text-center pb-10 font-semibold  pl-28 text-slate-950 underline underline-offset-8'>Commitment to Scientific Excellence</h2>
                <div className=' w-full h-5/6 flex items-center justify-around gap-5 p-5'>
                    <div className=' w-4/12 border-2 border-zinc-950 p-4 rounded-3xl '>
                        <img src={test} />
                        <img src={medi} />
                    </div>
